...
```
pod 'Moya-ModelMapper', '9.0.0-beta.1'
```

The subspec if you want to use the bindings over RxSwift.
```
pod 'Moya-ModelMapper/RxSwift', '9.0.0-beta.1'
```

And the subspec if you want to use the bindings over ReactiveSwift.
```
pod 'Moya-ModelMapper/ReactiveSwift', '9.0.0-beta.1'
```
...
```
github "sunshinejr/Moya-ModelMapper" "9.0.0-beta.1"
```
...
```swift
.package(url: "https://github.com/sunshinejr/Moya-ModelMapper.git", .exact("9.0.0-beta.1"))
```
