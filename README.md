...
```
pod 'Moya-ModelMapper/ReactiveSwift', '~> 5.0.0'
```
...
```
github "sunshinejr/Moya-ModelMapper" ~> 5.0
```
...
```swift
.Package(url: "https://github.com/sunshinejr/Moya-ModelMapper.git", Version(5, 0, 0))
```
